...
if(isset($_POST["submit"])) {
    $cours->createCour($_POST["label"], $_POST["description"], $_POST["enseignant"], $_POST["date"]);
...
<body>
    ...
    <div class="body">
        <form action="" method="post">
            <input placeholder="Libellée du cours" name="label" required>
            <input placeholder="Description du cours" name="description" required>
            <input type="date" id="start" name="date" value="<?=$date?>" min="2018-01-01" max="<?=$date?>">
